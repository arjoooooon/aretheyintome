...
prompt_system = "You are a dating coach talking to a romantically unsuccessful college CS major (likely male) who is confused by their crush's text messages."
...
def but_why(responses, inputs):
    ...
    for i, response in enumerate(responses):
        prompt += str(i+1) + f". Explain why this text conversation was classified as \"{response.prediction}\" with {round(response.confidence,3)} confidence: \"{inputs[i]}\".\n"
    #print(prompt)
